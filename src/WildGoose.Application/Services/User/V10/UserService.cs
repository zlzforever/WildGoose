...
using WildGoose.Application.Services.User.V10.Command;
using WildGoose.Application.Services.User.V10.Dto;
using WildGoose.Domain;
using WildGoose.Domain.Entity;
using WildGoose.Domain.Options;

namespace WildGoose.Application.Services.User.V10;
    ...
    : BaseService(dbContext, session, dbOptions, logger, memoryCache)
{
    public async Task ResetPasswordAsync(ResetPasswordCommand command)
    {
        ...
        if (extension == null)
        {
            ...
            extension.SetPasswordInfo(command.NewPassword);
