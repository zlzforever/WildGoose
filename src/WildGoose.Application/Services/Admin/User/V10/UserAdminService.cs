...
using WildGoose.Application.Services.Admin.User.V10.Dto;
using WildGoose.Application.Services.Admin.User.V10.IntegrationEvents;
using WildGoose.Application.Services.Admin.User.V10.Queries;
...
namespace WildGoose.Application.Services.Admin.User.V10;
